...
- `etc/merc.ini` is the tracked template; `src/merc.ini` is the generated active configuration and is intentionally ignored via `.gitignore`. See `docs/merc.ini.snapshot` for the pre-modernization copy.
